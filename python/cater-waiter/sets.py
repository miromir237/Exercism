...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if VEGAN.issuperset(set(dish_ingredients)):
        return f"{dish_name}: VEGAN"
    elif VEGETARIAN.issuperset(set(dish_ingredients)):
        return f"{dish_name}: VEGETARIAN"
    elif PALEO.issuperset(set(dish_ingredients)):
        return f"{dish_name}: PALEO"
    elif KETO.issuperset(set(dish_ingredients)):
