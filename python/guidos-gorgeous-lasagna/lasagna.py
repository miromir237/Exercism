...
def preparation_time_in_minutes(number_of_layers):
    ...
    :param number_of_layers: int - number of layers to be added.
    ...
    an argument and returns how many minutes you'll spend preparing the
    lasagna based on the `PREPARATION_TIME` per layer.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    layers you added to the lasagna, and the second argument is the number of
    minutes the lasagna has been in the oven. The function returns how many
    minutes in total you've worked on cooking the lasagna.
    """

    return int (preparation_time_in_minutes(number_of_layers) + elapsed_bake_time)

# Path: python/guidos-gorgeous-lasagna/test_lasagna.py